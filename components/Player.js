...
import { RewindIcon, FastForwardIcon, PauseIcon, ReplyIcon, PlayIcon, VolumeUpIcon } from "@heroicons/react/solid";
...
function Player() {
  ...
  return (
  <div className="h-24 bg-gradient-to-b from-black to-gray-900 text-white grid grid-cols-3 text-xs md:test-base px-2 md:px-8">
